...
// ==== Challenge 2: Use .map() similar to forEach and that it runs through each item map turns them into a new array ====
...
runners.map(function(items) {
    allCaps.push(items.first_name.toUpperCase());
}
);
console.log(allCaps); 

// ==== Challenge 3: Use .filter() reference yesterdays video====
...
// ==== Challenge 4: Use .reduce() replit:https://repl.it/@JadeLopez/Observing-Array-Methods ====
...
//   the zero tells the accumelator (acc) where to start
